...
You did it — you've successfully written event listeners and manipulated the
DOM.  Before that even, you've successfully written functions, conditional
statements, comparisons, all the way back to variables. Before we move on to
jQuery, we've got a challenge that will utilize everything we've learned, plus a
few new concepts we will cover in this readme.
...
by passing it a callback that contains our animation:
